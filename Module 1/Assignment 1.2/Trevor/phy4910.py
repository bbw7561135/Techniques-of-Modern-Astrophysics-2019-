...
def plot(x, f, xlabel="", ylabel=""):
    ...
    Where x is the independent variable. f is a list of dependent variables. Using this function you can plot
...
def plot2(x, f, xlabel="", ylabel="", logx= False, logy=False):
...
def plot_print(x, f, filename, xlabel="", ylabel=""):
    ...
    Where x is the independent variable. f is a list of dependent variables. Using this function you can plot
    multiple dependent variables 
    against x. Filename is the name of the saved pdf file
    """
    fig = plt.figure(figsize=(6, 4))
    ax = fig.add_subplot(1,1,1)
    for i in range(len(f)):     
