...
phy4910.plot_print(rhoCR, proper_mass/2e30, "assignment1c4a.pdf","Central Density", "Solar Masses")
print("Stable mass: {}".format(max(proper_mass/2e30)))

phy4910.plot_print(rhoCR, radii, "assignment1c4b.pdf","Central Density", "Solar Radii/100")

phy4910.plot_print(proper_mass/2e30,radii, "assignment1c4c.pdf", "Solar Masses", "Solar Radii/100")
